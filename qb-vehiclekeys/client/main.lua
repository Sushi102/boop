...
function LockpickDoor(isAdvanced)
    ...
    if boostingInfo ~= nil and boostingInfo.advancedSystem then
        ...
        QBCore.Functions.Notify('You need a proffessional system to lockpick this vehicle!', 'error')
        return 
    else
            ...
            if #(pos - vehpos) < 2.5 then
                ...
                if (vehLockStatus >= 2) then
                    ...
                    if usingAdvanced then
                        TaskPlayAnim(ped, "veh@break_in@0h@p_m_one@", "low_force_entry_ds", 3.0, 3.0, -1, 16, 1, 1, 0, 0)
